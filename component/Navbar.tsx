...
export const Navbar = () => {
    ...
    return (
        <div>
            <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-white bg-opacity-90 fixed top-0 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
